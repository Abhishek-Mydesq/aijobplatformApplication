...
public interface ApplicationService {
    ...
    PageResponse<ApplicationResponse> getApplicationsByUser(Long userId, int page, int size);
    PageResponse<ApplicationResponse> getApplicationsByJob(Long jobId, int page, int size);
